...
# 自动下载模型时，指定使用modelscope；否则，会默认从HuggingFace下载
...
if __name__ == "__main__":
    # 初始化 vLLM 推理引擎
    model = "./models/DeepSeek-R1-Distill-Llama-8B-1"  # 指定模型路径
    ...
    for output in outputs:
        ...
        print(
            f"Prompt: {prompt!r}, Think: {think_content!r}, Answer: {answer_content!r}"
        )
